...
|---|---|---|
| App registration + client secret | Identity only — grants nothing by itself | Entra ID (any app admin) |
...
- What you'd need from central IT: an app registration + secret + service
